...
export function AdminMap({ points, onPick }: { points: Array<{ id: string; lat: number; lon: number; address: string }>; onPick: (lat: number, lon: number) => void }) {
  return (
    <MapContainer center={[57.591, 34.563]} zoom={14} scrollWheelZoom>
